  ...
  return (
    <>
      <section className="relative min-h-[calc(100vh+90px)] text-white flex items-center justify-center overflow-hidden px-4 sm:px-6">
        ...
        {/* Навигация */}
        <nav className="absolute top-4 sm:top-6 inset-x-0 z-20 px-4 sm:px-5">
          <div className="relative max-w-8xl mx-auto flex items-center justify-between text-white/80 text-sm md:text-base gap-4">
            {/* ЛОГО */}
            <div className="">
              <Logo width={'150px'} />
            </div>
            ...
            <div className="hidden lg:flex flex-1 justify-center gap-6 sm:gap-3 lg:gap-8 text-center md:text-sm lg:text-base">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#feedback"
                className="hidden lg:block bg-main text-white py-4 px-5 text-lg rounded-full hover:opacity-80 transition"
              >
                Оставить заявку
              </a>
          ...
          {isOpen && (
            <div className="lg:hidden mt-4 px-4 py-4 bg-[#17213f] rounded-xl shadow-md border border-white/10 flex flex-col gap-4 text-white/90">
              ...
              <a
                href="#feedback"
                className="mt-2 bg-main text-white py-4 px-5 text-center text-lg rounded-full hover:opacity-80 transition"
              >
                Оставить заявку
              </a>
            </div>
        ...
        {/* Контент */}
        <div className="relative z-10 max-w-8xl flex flex-col lg:flex-row items-center justify-center gap-12 sm:gap-16 md:gap-24 lg:gap-40 xl:gap-60 mt-32 px-2 sm:px-4">
          <motion.div
            ref={refText}
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl max-w-xl text-white/80 mb-6 sm:mb-8">
              ...
              <br />
              Работает <span className="text-main text-2xl font-bold">24/7</span>. Реагирует
              мгновенно
            </p>
            <p className="text-xl sm:text-2xl text-white/80 mb-10">
              Не болеет, не уходит в отпуск и не требует зарплату
            </p>
            <a
              href="#feedback"
              className="bg-main text-white py-5 px-5 text-lg sm:px-8 rounded-full sm:text-xl hover:opacity-80 transition"
            >
              Попробовать сейчас
            </a>
          </motion.div>
