        ...
        <nav className="absolute top-4 sm:top-6 inset-x-0 z-20 px-4 sm:px-6 md:px-12">
          <div className="relative max-w-8xl mx-auto flex flex-wrap justify-between items-center gap-y-4 text-white/80 text-sm md:text-base">
            ...
            <div className="hidden lg:flex flex-1 justify-center gap-6 xl:gap-8">
              <a href="#benefits" className="hover:text-white transition block">
                Преимущества
              </a>
              <a href="#stats" className="hover:text-white transition block">
                Я теряю клиентов
              </a>
              <a href="#usecases" className="hover:text-white transition block">
                Где использовать
              </a>
              <a href="#how" className="hover:text-white transition block">
                Как работает
              </a>
              <a href="#comparison" className="hover:text-white transition block">
