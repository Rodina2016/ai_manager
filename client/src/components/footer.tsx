    ...
    return (
      <footer className="bg-[linear-gradient(180deg,_#0f0f1f,_#161942)] text-white py-12 px-6 md:px-24">
        <div className="max-w-7xl mx-auto grid gap-10 md:grid-cols-3 sm:grid-cols-2">
          ...
          <div>
            ...
            <ul className="text-sm text-white/70 space-y-2">
              <li>Email: <a href="mailto:mike.godunoff2020@gmail.com" className="hover:text-white">mike.godunoff2020@gmail.com</a></li>
              <li>Telegram: <a href="https://t.me/mike_salestech" className="hover:text-white">@mike_salestech</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-white/20 pt-6 text-center text-sm text-white/50">
          © {new Date().getFullYear()} ИИ-менеджер. Все права защищены.
        </div>
      </footer>
    );
  };
